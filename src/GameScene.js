    ...
    return (hours == "00"?"": hours+"h ") + (minutes == "00"?"": minutes+"m ") + seconds+"s";
          ...
          this.scene.start("title");
            ...
            if(this.spectating) return;
				...
				//go packet
				var server = this.options.server == "us2" ? "https://sword-io-game.herokuapp.com" : this.options.server == "us1" ? "https://sword-io-game.herokuapp.com" : "https://swordbattle.herokuapp.com";
				//server = undefined
