...
var progress = 1 - (remainder / total);
        ...
        this.load.image("blackhoodPlayer", "/assets/images/blackhoodPlayer.png");
        this.load.image("blackhoodSword", "/assets/images/blackhoodSword.png");
        this.load.image("alanPlayer", "/assets/images/alanPlayer.png");
        this.load.image("alanSword", "/assets/images/alanSword.png");
