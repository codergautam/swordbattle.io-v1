      ...
      Object.values(PlayerList.players).forEach((enemy) => {
        ...
        if (enemy && enemy.id != this.id && !PlayerList.deadPlayers.includes(enemy.id)) {
          ...
          if (
            ...
            if(!enemy.ai && (enemy.verified || (enemy.coins > 1000))) sql`INSERT INTO games (id, name, coins, kills, time, verified, killedby, killerverified) VALUES (${enemy.id}, ${enemy.name}, ${enemy.coins}, ${enemy.kills}, ${Date.now() - enemy.joinTime}, ${enemy.verified}, ${this.name}, ${this.verified})`;
