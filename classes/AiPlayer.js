...
class AiPlayer extends Player {
    constructor(id) {
        ...
        super(id, randomElement(["PlopyFun", "RoadCode", "32hropat", "Typer32", "McGod", "MitBlade", "Killer", "12345", "Hacker326", "sword", "swordgod", "sword.io", "player", "Alex", "Rajesh", "Ram","Emily", "Steve", "Max", "Lily", "Rohit", "Shiva", "Krishna", "Fan", "Liam", "Noah", "Emma", "Olivia", "mollthecoder", "RayhanADev", "amasad", "Elon Musk", "Jeff Bezos", "ur bad LMAO", "killsword", "swordKILLER", "EvasiveCollecter", "123asd", "Name", "Yeet", "Idiot", "Tamil", "Hindi", "Telugu", "Kannada", "Malayalam", "USA", "Pakistan", "Malaysia", "UAE", "Enter name", "Hero", "Warrior"]))
        this.ai = true;
