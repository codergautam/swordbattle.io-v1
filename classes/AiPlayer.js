...
class AiPlayer extends Player {
    constructor(id) {
        ...
        super(id, randomElement(["PlopyFun", "RoadCode", "32hropat", "Typer32", "McGod", "MitBlade", "Killer", "12345", "Hacker326", "sword", "swordgod", "sword.io", "player", "Alex", "Rajesh", "Ram","Emily", "Steve", "Max", "Lily", "Rohit", "Shiva", "Krishna", "Fan", "Liam", "Noah", "Emma", "Olivia"]))
        this.ai = true;
...
if(!this.target || !this.entityExists(this.target,this.getEntities(coins))) this.target = this.getClosestEntity(this.getEntities(coins))
    ...
    getEntities(coins) {
      ...
      return (this.coins < 5000 ? entities : players)
      //return players
    }
    getTpos() {
      try {
